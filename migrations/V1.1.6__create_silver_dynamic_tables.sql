...
CREATE OR ALTER DYNAMIC TABLE SILVER_LAYER.ORDER_ITEMS (
	ORDER_ID,
	ORDER_ITEM_ID,
	PRODUCT_ID,
	SELLER_ID,
...
FROM BRONZE_LAYER.ORDER_ITEMS_RAW;

CREATE OR ALTER DYNAMIC TABLE SILVER_LAYER.ORDER_PAYMENTS (
	ORDER_ID,
	PAYMENT_SEQUENTIAL,
	PAYMENT_TYPE,
...
FROM BRONZE_LAYER.ORDER_PAYMENTS_RAW;

CREATE OR ALTER DYNAMIC TABLE SILVER_LAYER.ORDER_REVIEWS (
	REVIEW_ID,
	ORDER_ID,
	REVIEW_SCORE,
...
SELECT
    ...
    REVIEW_CREATION_DATE,
    REVIEW_ANSWER_TIMESTAMP
FROM BRONZE_LAYER.ORDER_REVIEWS_RAW
